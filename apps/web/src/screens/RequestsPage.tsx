...
const styles = StyleSheet.create({
  ...
  subtitle: { marginTop: 7, color: theme.color.muted, fontSize: 12 },
  ...
  rowFolio: { color: theme.color.muted, fontSize: 10, fontWeight: '700' },
  ...
  emptyDetail: { color: theme.color.muted, fontSize: 12 },
  detailHead: {
    flexDirection: 'row',
  ...
  detailFolio: { color: theme.color.navy, fontSize: 16, fontWeight: '800' },
  detailRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    paddingVertical: 8,
  ...
  detailLabel: { color: theme.color.muted, fontSize: 11 },
  detailValue: {
