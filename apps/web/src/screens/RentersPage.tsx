...
export function RentersPage() {
  ...
  const onSetStatus = async (userId: string, status: Extract<RenterStatus, 'approved' | 'rejected'>) => {
    setBusyId(userId);
    try {
...
const styles = StyleSheet.create({
  ...
  tabText: { color: theme.color.muted, fontWeight: '700', fontSize: theme.font.size.sm },
  ...
  name: { color: theme.color.navy, fontSize: theme.font.size.lg, fontWeight: '800' },
  email: { color: theme.color.muted, marginTop: 2, fontSize: theme.font.size.sm },
  statusPill: {
  ...
  statusText: { color: theme.color.navy, fontSize: 11, fontWeight: '800' },
  grid: { gap: 8 },
  field: {},
  fieldLabel: { color: theme.color.muted, fontSize: 11, fontWeight: '700' },
  fieldValue: { color: theme.color.ink, fontSize: theme.font.size.md, fontWeight: '600' },
  ...
  reopenText: { color: theme.color.navy, fontWeight: '700' },
});
